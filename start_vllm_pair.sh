...
CHEM_MAX_MODEL_LEN="${CHEM_MAX_MODEL_LEN:-8192}"
CHEM_GPU_MEMORY_UTILIZATION="${CHEM_GPU_MEMORY_UTILIZATION:-0.90}"
CHEM_EXTRA_ARGS="${CHEM_EXTRA_ARGS:-}"

# Gemma defaults (set GEMMA_MODEL_ID to your quantized model if needed)
...
GEMMA_GPU_MEMORY_UTILIZATION="${GEMMA_GPU_MEMORY_UTILIZATION:-0.75}"
GEMMA_EXTRA_ARGS="${GEMMA_EXTRA_ARGS:-}"

DEFAULT_ACTIVE_MODEL="${DEFAULT_ACTIVE_MODEL:-chemdfm}" # chemdfm|gemma
